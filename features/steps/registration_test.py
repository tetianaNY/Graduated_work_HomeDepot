...
def registration_form(context):
    context.app.registration_page.registration_form_email('seniorus_pomidorus653@korolevstvo.nyc')
    ...
    context.app.registration_page.registration_form_phone('2015636563')
